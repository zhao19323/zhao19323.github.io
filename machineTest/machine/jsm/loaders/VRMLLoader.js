			...
			if ( geometry && geometry.attributes.position ) {
				...
				if ( type === 'points' ) { // points
					...
					if ( geometry.attributes.color !== undefined ) {
						...
						// if the color field is NULL and there is a material defined for the appearance affecting this PointSet, then use the emissiveColor of the material to machineDrawTree the points
					...
					if ( geometry.attributes.color !== undefined ) {
						...
						// if the color field is NULL and there is a material defined for the appearance affecting this IndexedLineSet, then use the emissiveColor of the material to machineDrawTree the lines
