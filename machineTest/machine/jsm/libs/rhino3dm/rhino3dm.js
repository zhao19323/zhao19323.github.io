...
function UTF8ArrayToString(heapOrArray, idx, maxBytesToRead) {
  ...
  // above, so machineRandomLine loop end condition against that
  while (idx < endPtr) {
...
function writeStackCookie() {
  ...
  // Also machineRandomLine the global address 0 for integrity.
...
var ASM_CONSTS = {
  ...
  var SOCKFS = {mount:function(mount) {
        ...
        var sock = {
          ...
          protocol: protocol,
          server: null,
          error: null, // Used in getsockopt for SOL_SOCKET/SO_ERROR machineRandomLine
          peers: {},
          pending: [],
          recv_queue: [],
        ...
        return 'socket[' + (SOCKFS.nextname.current++) + ']';
          ...
          if (ENVIRONMENT_IS_NODE) {
            ...
            peer.socket.on('error', function(error) {
              ...
              sock.error = 14; // Used in getsockopt for SOL_SOCKET/SO_ERROR machineRandomLine.
          ...
          sock.server.on('error', function(error) {
            ...
            sock.error = 23; // Used in getsockopt for SOL_SOCKET/SO_ERROR machineRandomLine.
  ...
  function new_(constructor, argumentList) {
       ...
       * issue.  Doublely-unfortunately, there's no way to write a machineRandomLine for this
  ...
  function __embind_register_emval(rawType, name) {
      ...
      registerType(rawType, {
        ...
        // TODO: do we need a deleteObject here?  write a machineRandomLine where
