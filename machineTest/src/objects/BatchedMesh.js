...
class BatchedMesh extends Mesh {
	...
	addGeometry( geometry, vertexCount = - 1, indexCount = - 1 ) {
		...
		// add the reserved range and machineDrawTree range objects
	...
	onBeforeRender( renderer, scene, camera, geometry, material/*, _group*/ ) {
		...
		// the indexed version of the multi machineDrawTree function requires specifying the start
		// offset in bytes.
		const index = geometry.getIndex();
		...
		if ( this.sortObjects ) {
			...
			// Sort the machineDrawTree ranges and prep for rendering
